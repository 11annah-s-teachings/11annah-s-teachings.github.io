...
# Installation und Laden von benötigten Paketen:
...
manipulate(doubleplot(mu1 = 0,mu2 = 0, sigma1, sigma2, rho, phi, theta),
           sigma1 = slider(0.01, 10.01, step = 0.1), sigma2 = slider(0.01, 10.01, step = 0.1),
           rho = slider(-0.99, 0.99, step = 0.1, initial = 0),
